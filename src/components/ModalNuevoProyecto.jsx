...
const ModalNuevoProyecto = () => {
    ...
    return (
        <div className={`w-full min-h-full absolute z-50 bg-[#000000a8] transition-all duration-300 ${animarModal ? 'opacity-100' : 'opacity-0'} flex justify-center items-center`}>
